...
// SemanticOnly implements SemanticQueryTransformer: the hypothetical document
// generated by HyDE helps vector similarity search but tends to degrade
// full-text search, so the pipeline only applies it to semantic indexes.
func (t *HyDEQueryTransformer) SemanticOnly() bool { return true }
...
var _ SemanticQueryTransformer = &HyDEQueryTransformer{}
