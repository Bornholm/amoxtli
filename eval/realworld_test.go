...
// measured 5.9x faster than Ollama on the same model, which is what turns a
// 35-minute ingestion into a 6-minute one. It takes precedence over
...
func embeddingsClient(t *testing.T) (llm.Client, string) {
	...
	// where most of the measured 5.9x over Ollama comes from. See
	// docs/embeddings-backend-eval.md.
